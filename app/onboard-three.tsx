...
import background from '../assets/images/travel-2.jpg';
    ...
    return (
        <ImageBackground source={background} style={styles.container}>
            ...
            <View >
                ...
                <PoppinsText style={styles.title}>Lorem ipsum dolor</PoppinsText>
            ...
            <View style={styles.bottomBox}>
                ...
                <View style={styles.whiteBox}>
                    <Animated.View style={[styles.startButton, { transform: [{ scale: scaleAnim }] }]}>
                        ...
                        >
                            <PoppinsText style={styles.boxTitle}>Get Started</PoppinsText>
